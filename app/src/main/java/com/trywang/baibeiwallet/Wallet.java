...
public class Wallet {
    ...
    public static ECKeyPair decrypt(String password, WalletFile walletFile)
        ...
        Log.i("TAG", "decrypt: 总耗时 1 = " + timeSpace);
...
//        WalletFile.KdfParams kdfParams = ;
        if (crypto.getKdfparams() instanceof WalletFile.ScryptKdfParams) {
            ...
            timeSpace = System.currentTimeMillis() - startTime;
            Log.i("TAG", "decrypt:c 总耗时 2.0.0 = " + timeSpace);
            derivedKey = generateAes128CtrDerivedKey(
                    password.getBytes(Charset.forName("UTF-8")), salt, c, prf);
            timeSpace = System.currentTimeMillis() - startTime;
            Log.i("TAG", "decrypt:c 总耗时 2.0 = " + timeSpace);
        } else {
            throw new CipherException("Unable to deserialize params: " + crypto.getKdf());
        }
        timeSpace = System.currentTimeMillis() - startTime;
        Log.i("TAG", "decrypt: 总耗时 2 = " + timeSpace);
        ...
        timeSpace = System.currentTimeMillis() - startTime;
        Log.i("TAG", "decrypt: 总耗时 3 = " + timeSpace);
